...
= Sistema Bancário para Testes com JUnit 5 image:https://img.shields.io/github/workflow/status/jlucasguedes/CoberturaCodigo/maven[GitHub Workflow Status]
...
== Relatório Cobertura de código - João Lucas Guedes de Oliveira
